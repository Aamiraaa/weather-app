## First of all install all liabraries as you import here
##  python -m tkinter and pip install geopy,timezonefinder, requests, pytz
## And also you want some png images and save 
...
# add Api key Weather
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=b39427e16a4ead3fb9de170473b76390"
